...
export function parseTajweed(text: string): string {
  ...
  return text
    .replace(/\[g\](.*?)\[\/g\]/g, '<span class="tajweed-ghunna cursor-help text-orange-600 font-bold" data-rule="Ghunna">$1</span>')
    .replace(/\[p\](.*?)\[\/p\]/g, '<span class="tajweed-qalqala cursor-help text-blue-600 font-bold" data-rule="Qalqala">$1</span>')
    .replace(/\[m\](.*?)\[\/m\]/g, '<span class="tajweed-madd cursor-help text-pink-600 font-bold" data-rule="Madd">$1</span>')
    .replace(/\[i\](.*?)\[\/i\]/g, '<span class="tajweed-ikhfa cursor-help text-green-600 font-bold" data-rule="Ikhfa">$1</span>')
    .replace(/\[d\](.*?)\[\/d\]/g, '<span class="tajweed-idgham cursor-help text-purple-600 font-bold" data-rule="Idgham">$1</span>')
    .replace(/\[s\](.*?)\[\/s\]/g, '<span class="tajweed-ikhfa-shafawi cursor-help text-emerald-600 font-bold" data-rule="Ikhfa Shafawi">$1</span>')
